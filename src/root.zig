...
pub const algorithms = struct {
    ...
    pub const sorting = struct {
        ...
        pub const gnomeSort = @import("algorithms/sorting/gnomesort.zig").gnomeSort;
        pub const gnomeSortAsc = @import("algorithms/sorting/gnomesort.zig").gnomeSortAsc;
...
pub const stats = struct {
    ...
    /// Probability distributions — Normal, Uniform, Exponential, Laplace, AsymmetricLaplace, Weibull, Pareto, LogNormal, Cauchy, Gumbel, Gamma, Beta, ChiSquared, StudentT, F, Poisson, Binomial, Bernoulli, Geometric, NegativeBinomial, FisherNoncentralHypergeometric, Hypergeometric, MultivariateHypergeometric, Categorical, Multinomial, NegativeMultinomial, Dirichlet, Zipf, BetaBinomial, DirichletMultinomial, DiscreteUniform, Logarithmic, Skellam, Rademacher, Triangular, VonMises, Rayleigh, Kumaraswamy, HalfNormal, MaxwellBoltzmann, LogLogistic, Levy, Lindley, Lomax, Gompertz, Rice, Nakagami, InverseGaussian, InverseRayleigh, BirnbaumSaunders, GeneralizedLogistic, Slash, Frechet, BetaPrime, FoldedNormal, GeneralizedPareto, LogCauchy, Burr, Dagum, TruncatedNormal, PowerLaw, SkewNormal, HalfCauchy, HalfLogistic, LogUniform, Arcsine, Logistic, InverseGamma, Chi, NoncentralChi, NoncentralChiSquared, ToppLeone, WignerSemicircle, IrwinHall, Bates, JohnsonSU, Benford, LogLaplace, RaisedCosine, GompertzMakeham, Muth, NoncentralT, GeneralizedGamma, NoncentralF, NoncentralBeta, ReciprocalInverseGaussian, GeneralizedExtremeValue, LogitNormal, GeneralizedNormal, PowerNormal, HyperbolicSecant, YuleSimon, ConwayMaxwellPoisson, ConwayMaxwellBinomial, Kolmogorov, SinhArcsinh, Moyal, Erlang, Bradford, ContinuousBernoulli, PERT, TukeyLambda, Zeta, DiscreteWeibull, BoundedPareto, DoubleWeibull, ZipfMandelbrot, TruncatedExponential, GeneralizedExponential, LogGamma, WrappedCauchy, Epanechnikov, ShiftedGompertz, Benini, Biweight, Triweight, MarchenkoPastur, InverseChiSquared, ScaledInverseChiSquared, ExponentiatedWeibull, UQuadratic, GeneralizedRayleigh, ARGUS, FlorySchulz, CrystalBall, Trapezoidal, JohnsonSB, HalfStudentT, Borel, DiscreteGaussian, DiscreteLaplace, Landau, Davis, PearsonIII, GeneralizedInverseGaussian, NormalInverseGaussian, VarianceGamma, GeneralizedHyperbolic, WrappedNormal, WrappedLaplace, QExponential, ExGaussian, GB1, GB2, Chen, SkewCauchy, GeneralizedPoisson, Xgamma, PolyaAeppli, Delaporte, Waring, Kappa, NegativeHypergeometric, Champernowne, Meixner, MarshallOlkinExponential, MarshallOlkinWeibull, MarshallOlkinLomax, FoldedCauchy, FoldedT, ZeroInflatedPoisson, ZeroInflatedNegativeBinomial, ZeroInflatedBinomial, ZeroInflatedGeometric, HurdlePoisson, HurdleNegativeBinomial, HurdleBinomial, BetaGeometric, BorelTanner, Good, PoissonLindley, HyperPoisson, NeymanTypeA, Sichel, Hermite, GeneralizedHermite, SkewT, SkewSlash, ZeroTruncatedPoisson, ZeroTruncatedBinomial, ZeroTruncatedNegativeBinomial, BenktanderII, BenktanderI, BetaNegativeBinomial, HalfGeneralizedNormal, SkewGeneralizedNormal, WrappedExponential, Voigt, DoublePoisson, FoldedLogistic, BetaRectangular, LogPearsonIII, PoissonLognormal, ExponentialLogarithmic, JonesFaddySkewT, ShiftedLogNormal, ShiftedWeibull, ShiftedExponential, ShiftedGamma, ShiftedRayleigh, ShiftedChi, ShiftedNakagami, ShiftedInverseGaussian, DoubleGamma, BivariatePoisson, PoissonBinomial, BivariateBinomial, Wakeby, Sibuya
